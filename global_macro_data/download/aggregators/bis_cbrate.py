...
def download_bis_cbrate(
    *,
    ...
    base_path = raw_dir / "aggregators" / "BIS" / "BIS_cbrate"
    sh.gmdsavedate("BIS_cbrate", data_helper_dir=helper_dir, data_temp_dir=temp_dir)
    return sh.savedelta(master[columns], str(base_path), id_columns=["period", "ref_area", "series_code"])
__all__ = ["download_bis_cbrate"]
